...
```
$ s2i build https://github.com/pjiangcoding/httpd-ex centos/httpd-24-centos7 myhttpdimage
...
`$ oc new-app centos/httpd-24-centos7~https://github.com/pjiangcoding/httpd-ex`
